# Integração Django — Guia para implementação

Este documento é destinado a um agente de IA (ou desenvolvedor) que irá implementar o backend Django para o editor WYSIWYG. Descreve o que o editor já possui, como ele funciona e o que precisa ser criado no Django.

---

## 1. O que é o editor

Editor WYSIWYG modular híbrido (estilo Gutenberg + Elementor) em **Vanilla JS (ES6+) + Bootstrap 5.3**, sem jQuery, sem framework. Projetado especificamente para ser embutido em sites Django como widget de formulário.
...
const editor = new Editor({
  ...
  // O |default:"null" é opcional desde 1.1.0.
  initialJSON:  {{ pagina.conteudo_json|safe|default:"null" }},

  // AUTO-SAVE — autoSaveKey é OBRIGATÓRIO desde 1.1.0 (chaves genéricas cruzam
  // rascunhos entre páginas). Sem ele o auto-save é desligado com warning.
...
def wysiwyg_assets(request):
    # Exemplo: listar arquivos da pasta de uploads
    from django.core.files.storage import default_storage
